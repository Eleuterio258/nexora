                ...
                <tr>
                    ...
                    <td>
                        <div class="adm-actions">
                            <a href="<?php echo htmlspecialchars($app->routes->path('rh_funcionario', ['id' => $app->id->encode((int)$f['id'])])) ?>" class="adm-btn adm-btn-ghost adm-btn-sm adm-btn-icon" title="Ver">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
