...
<head>
  ...
  <title><?= \E258Tech\Faturacao\Presentation\View\Html::e($title ?? 'PHC Faturação') ?></title>
...
<body>
  <div class="app-shell">
    <aside class="sidebar">
      ...
      <?php $authSession = new \E258Tech\Faturacao\Infrastructure\Auth\AuthSession(); ?>
      <div class="sidebar-foot">
        <span class="avatar"><?= \E258Tech\Faturacao\Presentation\View\Html::e(mb_strtoupper(mb_substr($authSession->userName() ?? '?', 0, 1))) ?></span>
        <span><b><?= \E258Tech\Faturacao\Presentation\View\Html::e($authSession->userName() ?? 'Sessão local') ?></b><small>Nexora</small></span>
    ...
    <main class="main">
      <header class="topbar">
        ...
        <form action="/documents" method="get" class="global-search">
          <span>⌕</span>
          <input id="globalSearch" name="search" type="search" placeholder="Pesquisar documentos, clientes ou artigos…" value="<?= \E258Tech\Faturacao\Presentation\View\Html::e($search ?? '') ?>">
          <kbd>Ctrl K</kbd>
        </form>
