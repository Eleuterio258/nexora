...
<nav class="pos-sidebar">
    ...
    <div class="pos-nav">
        <a href="<?= htmlspecialchars($app->routes->path('pos_operator_terminal')) ?>" class="pos-nav-item active"><i class="fa-solid fa-cash-register"></i> Vendas</a>
        <a href="<?= htmlspecialchars($app->routes->path('pos_manager_dashboard')) ?>" class="pos-nav-item"><i class="fa-solid fa-gauge"></i> Dashboard</a>
        <a href="<?= htmlspecialchars($app->routes->path('pos_admin_terminals')) ?>" class="pos-nav-item"><i class="fa-solid fa-desktop"></i> Caixas</a>
        <a href="<?= htmlspecialchars($app->routes->path('pos_manager_reports')) ?>" class="pos-nav-item"><i class="fa-solid fa-chart-bar"></i> Relatórios</a>
        <a href="/nexora/clientes" class="pos-nav-item"><i class="fa-solid fa-users"></i> Clientes</a>
        <a href="<?= htmlspecialchars($app->routes->path('pos_operator_returns')) ?>" class="pos-nav-item"><i class="fa-solid fa-rotate-left"></i> Devoluções</a>
    </div>
...
<div style="flex:1;display:flex;align-items:center;justify-content:center;background:#f8fafc">
    <div class="pos-modal" style="width:460px;box-shadow:var(--adm-shadow-md)">
        ...
        <p style="color:#6b7280;font-size:13px;margin-bottom:16px">
            ...
            <a href="<?= htmlspecialchars($app->routes->path('pos_admin_terminals')) ?>" style="color:#10b981">Criar terminal →</a>
        </p>
        <?php else: ?>
