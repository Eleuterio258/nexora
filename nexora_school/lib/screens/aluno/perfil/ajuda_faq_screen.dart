...
class _AjudaFaqScreenState extends State<AjudaFaqScreen> {
  ...
  static const _faqs = [
    _Faq(
      ...
      resposta: 'Aceda ao separador "Boletim" na barra de navegação inferior. Pode seleccionar o trimestre no selector de período no topo da página.',
    ),
    _Faq(
      pergunta: 'Como pagar a propina pelo M-Pesa?',
      resposta: 'No separador "Financeiro", toque no botão "Pagar" na propina pendente. Seleccione "M-Pesa" e marque o USSD *150*1# no seu telemóvel com a referência indicada.',
    ),
    _Faq(
      pergunta: 'Como ver o meu horário semanal?',
      resposta: 'Aceda ao separador "Agenda" e toque em "Semana" para ver todas as aulas da semana. Use "Dia" para ver apenas o dia actual.',
    ),
    _Faq(
      pergunta: 'Como alterar a minha senha?',
      resposta: 'Vá a Perfil → Segurança → Alterar senha. Introduza a senha actual e defina uma nova com pelo menos 8 caracteres.',
    ),
    _Faq(
      pergunta: 'O que significa "Em Risco" no boletim?',
      resposta: 'Significa que a sua média geral está abaixo de 10 valores (escala 0–20). Contacte o seu professor de acompanhamento para apoio.',
    ),
    _Faq(
      pergunta: 'Como activar notificações de notas?',
      resposta: 'Aceda a Perfil → Notificações e active a opção "Notas e boletim".',
    ),
  ];
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const SizedBox(height: 4),
          const Text('Encontre respostas às dúvidas mais comuns.',
              style: TextStyle(fontSize: 13, color: Color(0xFF8E8E93))),
          const SizedBox(height: 20),
          ...List.generate(_faqs.length, (i) => Padding(
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          border: expanded ? Border.all(color: _green.withValues(alpha: 0.4)) : null,
          boxShadow: [
            BoxShadow(
  ...
  Widget _buildContactCard(BuildContext context) {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Ainda tem dúvidas?',
              style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold, color: _navy)),
          const SizedBox(height: 6),
          const Text('Entre em contacto com o nosso suporte.',
              style: TextStyle(fontSize: 13, color: Color(0xFF8E8E93))),
