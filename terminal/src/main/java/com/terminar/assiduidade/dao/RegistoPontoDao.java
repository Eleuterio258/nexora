...
public class RegistoPontoDao {
    ...
    public RegistoPonto insert(RegistoPonto registo) {
        ...
        String sql = "INSERT INTO registo_ponto (employee_id, employee_numero, employee_nome, metodo, "
        ...
        try (Connection conn = DatabaseManager.getConnection();
            ...
            ps.setString(4, registo.getMetodo().name());
            ps.setString(5, registo.getObservacao());
            ps.setString(6, registo.getDataHora().format(DATA_HORA));
            ps.executeUpdate();
