...
final class ComercialPageRoutes
{
    public static function pages(): array
    {
        return [
            ...
            // POS — redireccionamentos temporários para os novos portais /pos/*
            'pos'                       => ['path' => '/nexora/pos', 'view' => 'pos_redirect.php', 'permission' => 'pos'],
            'pos_dashboard'             => ['path' => '/nexora/pos/dashboard', 'view' => 'pos_redirect.php', 'permission' => 'pos'],
            'pos_vendas'                => ['path' => '/nexora/pos/vendas', 'view' => 'pos_redirect.php', 'permission' => 'pos'],
            'pos_venda_ver'             => ['path' => '/nexora/pos/vendas/ver', 'view' => 'pos_redirect.php', 'permission' => 'pos'],
            'pos_terminais'             => ['path' => '/nexora/pos/terminais', 'view' => 'pos_redirect.php', 'permission' => 'pos'],
            'pos_catalogo'              => ['path' => '/nexora/pos/catalogo', 'view' => 'pos_redirect.php', 'permission' => 'pos'],
            'pos_relatorios'            => ['path' => '/nexora/pos/relatorios', 'view' => 'pos_redirect.php', 'permission' => 'pos'],
            'pos_devolucoes'            => ['path' => '/nexora/pos/devolucoes', 'view' => 'pos_redirect.php', 'permission' => 'pos'],
            'pos_sessoes'               => ['path' => '/nexora/pos/sessoes', 'view' => 'pos_redirect.php', 'permission' => 'pos'],
            'pos_sessa_abrir'           => ['path' => '/nexora/pos/sessoes/abrir', 'view' => 'pos_redirect.php', 'permission' => 'pos'],
            'pos_sessa_detalhe'         => ['path' => '/nexora/pos/sessoes/ver', 'view' => 'pos_redirect.php', 'permission' => 'pos'],
            'pos_sessa_fecho'           => ['path' => '/nexora/pos/sessoes/fechar', 'view' => 'pos_redirect.php', 'permission' => 'pos'],
            'pos_relatorio_fecho'       => ['path' => '/nexora/pos/relatorios/fecho', 'view' => 'pos_redirect.php', 'permission' => 'pos'],
            'pos_descontos'             => ['path' => '/nexora/pos/descontos', 'view' => 'pos_redirect.php', 'permission' => 'pos'],
            // Produtos & Stock
