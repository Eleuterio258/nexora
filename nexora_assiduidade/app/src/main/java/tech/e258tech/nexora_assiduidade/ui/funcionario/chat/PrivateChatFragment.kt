 ...
 * Conversa privada entre dois usuários com WebSocket nativo.
 */
class PrivateChatFragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(chatId: Long, title: String? = null): PrivateChatFragment {
            return PrivateChatFragment().apply {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<TextView?>(R.id.tvChatTitle)?.text = chatTitle ?: "Chat Privado"
        ...
        if (chatId != 0L) {
            ...
            Toast.makeText(context, "Chat não especificado", Toast.LENGTH_SHORT).show()
        }
    ...
    private fun addMessage(message: ChatMessage) {
        // Se já existe mensagem local pendente com o mesmo conteúdo do nosso utilizador,
        // não adiciona duplicado; o ACK substituirá o ID local pelo ID do servidor.
        ...
        adapter.submitList(messages.toList()) {
            view?.findViewById<RecyclerView>(R.id.recyclerViewMessages)
    ...
    private fun sendMessage(message: String) {
        ...
        val clientId = ChatWebSocketService.sendMessage(chatId, message)
        ...
        // Se o WebSocket não conseguiu enviar imediatamente, a mensagem ficou
        // na fila do serviço. Ainda assim fazemos fallback HTTP como segurança extra.
