        ...
        title: Row(
          children: [
            Stack(
              children: [
                Container(
                  ...
                  child: Center(child: Text(_initials, style: const TextStyle(fontSize: 13, fontWeight: FontWeight.bold, color: _green))),
                ),
                if (widget.online)
                  Positioned(
                    bottom: 0, right: 0,
            ...
            Column(
              ...
              children: [
                Text(widget.nome, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: _navy)),
                Text(
                  widget.online ? 'Online agora' : widget.sub,
                  style: TextStyle(fontSize: 11, color: widget.online ? _green : const Color(0xFF8E8E93)),
                ),
              ],
            ),
          ],
