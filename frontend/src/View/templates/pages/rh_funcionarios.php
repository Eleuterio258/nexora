...
<div class="adm-card" style="max-width:640px">
    <div class="adm-card-body" style="text-align:center;padding:var(--adm-sp-12)">
        <i class="fa-solid fa-users" style="font-size:3rem;color:var(--adm-gray-300);margin-bottom:var(--adm-sp-4)"></i>
        <h2 class="adm-empty-title">Recursos Humanos nao disponivel</h2>
        <p class="adm-text-sm adm-text-muted" style="margin-bottom:var(--adm-sp-6)">
            O backend PayCore ainda nao possui modulos de RH (funcionarios, ferias, assiduidade, recibos de vencimento, etc.).
        </p>
    </div>
</div>
