...
<div class="adm-page-header" style="align-items:flex-start">
    ...
    <div class="adm-page-header-actions">
        <?php if ($isEdit): ?>
        <a href="/nexora/faturacao/orcamentos/proforma?id=<?php echo $id ?>" target="_blank" class="adm-btn adm-btn-outline adm-btn-sm">
...
async function saveOrcamento() {
    ...
    try {
        ...
        if (data.ok) {
            window.location.href = '/nexora/faturacao/orcamentos/form?id=' + data.id;
        } else {
