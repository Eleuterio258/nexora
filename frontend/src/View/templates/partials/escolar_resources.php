...
return [
    ...
    'years' => [
        ...
        'actions' => [
            ...
            ['operation' => 'term.create', 'label' => 'Novo período', 'fields' => [
                ['name' => 'nome', 'label' => 'Nome do período (ex: 1º Semestre, Módulo 1)', 'required' => true],
                ['name' => 'tipo', 'label' => 'Tipo', 'type' => 'select', 'options' => ['trimestre', 'semestre', 'bimestre', 'modulo', 'outro'], 'required' => true],
                ['name' => 'level_id', 'label' => 'Nível de ensino (ID)', 'type' => 'number', 'required' => true],
                ['name' => 'data_inicio', 'label' => 'Início', 'type' => 'date', 'required' => true],
                ['name' => 'data_fim', 'label' => 'Fim', 'type' => 'date', 'required' => true],
                ['name' => 'peso', 'label' => 'Peso (para média ponderada)', 'type' => 'number'],
                ['name' => 'ordem', 'label' => 'Ordem (posição na tabela)', 'type' => 'number'],
            ]],
            ['operation' => 'term.update', 'label' => 'Editar período', 'fields' => [
                ['name' => 'nome', 'label' => 'Nome do período'],
                ['name' => 'tipo', 'label' => 'Tipo', 'type' => 'select', 'options' => ['trimestre', 'semestre', 'bimestre', 'modulo', 'outro']],
                ['name' => 'level_id', 'label' => 'Nível de ensino (ID)', 'type' => 'number', 'required' => true],
            ...
            ['operation' => 'term.delete', 'label' => 'Eliminar período', 'confirm' => 'Eliminar este período? Só é possível se não tiver avaliações lançadas.'],
            ['operation' => 'year.activate', 'label' => 'Activar'],
            ['operation' => 'year.close', 'label' => 'Encerrar', 'confirm' => 'Encerrar este ano lectivo?'],
        ],
    ],
    'terms' => [
        'label' => 'Períodos lectivos', 'path' => '/api/escolar/terms',
        'columns' => [
            ['nome', 'Período'],
            ['tipo', 'Tipo'],
            ['level_nome', 'Nível'],
            ['ano_nome', 'Ano lectivo'],
            ['data_inicio', 'Início'],
            ['data_fim', 'Fim'],
            ['peso', 'Peso'],
            ['ordem', 'Ordem'],
        ],
        'create' => ['operation' => 'term.create', 'label' => 'Novo período', 'fields' => [
            ['name' => '_id', 'label' => 'Ano lectivo (ID)', 'type' => 'number', 'required' => true],
            ['name' => 'nome', 'label' => 'Nome (ex: 1º Semestre, Módulo 1)', 'required' => true],
            ['name' => 'tipo', 'label' => 'Tipo', 'type' => 'select', 'options' => ['semestre', 'trimestre', 'bimestre', 'modulo', 'outro'], 'required' => true],
            ['name' => 'level_id', 'label' => 'Nível de ensino (ID)', 'type' => 'number', 'required' => true],
            ['name' => 'data_inicio', 'label' => 'Início', 'type' => 'date', 'required' => true],
            ['name' => 'data_fim', 'label' => 'Fim', 'type' => 'date', 'required' => true],
            ['name' => 'peso', 'label' => 'Peso (para média ponderada)', 'type' => 'number'],
        ...
        'actions' => [
            ['operation' => 'term.update', 'label' => 'Editar', 'fields' => [
                ['name' => 'nome', 'label' => 'Nome'],
                ['name' => 'tipo', 'label' => 'Tipo', 'type' => 'select', 'options' => ['semestre', 'trimestre', 'bimestre', 'modulo', 'outro']],
                ['name' => 'level_id', 'label' => 'Nível de ensino (ID)', 'type' => 'number', 'required' => true],
                ['name' => 'data_inicio', 'label' => 'Início', 'type' => 'date'],
                ['name' => 'data_fim', 'label' => 'Fim', 'type' => 'date'],
                ['name' => 'peso', 'label' => 'Peso', 'type' => 'number'],
            ...
            ['operation' => 'term.delete', 'label' => 'Eliminar', 'confirm' => 'Eliminar este período? Só é possível se não tiver avaliações lançadas.'],
        ],
    ],
    'classes' => [
    ...
    'courses' => [
        ...
        'create' => ['operation' => 'course.create', 'label' => 'Novo curso', 'fields' => [
            ...
            ['name' => 'tem_exame', 'label' => 'Tem exame final', 'type' => 'select', 'options' => ['false', 'true']],
        ]],
        'actions' => [
    ...
    'course_subjects' => [
        'label' => 'Currículo — Disciplinas', 'path' => '/api/escolar/course-subjects',
        'columns' => [
            ['subject_nome|subject_id', 'Disciplina'],
            ['course_nome|course_id', 'Curso'],
            ['series_nome|series_id', 'Série/Ano'],
            ['componente', 'Componente'],
            ['obrigatoria', 'Obrigatória'],
        ],
        'create' => ['operation' => 'course.subject.create', 'label' => 'Adicionar disciplina ao currículo', 'fields' => [
            ['name' => 'course_id',            'label' => 'Curso (ID)',         'type' => 'number', 'required' => true],
            ['name' => 'series_id',            'label' => 'Série/Ano (ID)',     'type' => 'number'],
            ['name' => 'subject_id',           'label' => 'Disciplina (ID)',    'type' => 'number', 'required' => true],
            ['name' => 'componente',           'label' => 'Componente',         'type' => 'select', 'options' => ['teorica', 'pratica', 'laboratorial', 'anual', 'outro']],
            ['name' => 'carga_horaria_semanal','label' => 'Carga horária/semana', 'type' => 'number'],
            ['name' => 'obrigatoria',          'label' => 'Obrigatória',        'type' => 'select', 'options' => ['true', 'false']],
        ]],
        'actions' => [
            ['operation' => 'course.subject.update', 'label' => 'Editar', 'fields' => [
                ['name' => 'componente',           'label' => 'Componente', 'type' => 'select', 'options' => ['teorica', 'pratica', 'laboratorial', 'anual', 'outro']],
                ['name' => 'carga_horaria_semanal','label' => 'Carga horária/semana', 'type' => 'number'],
                ['name' => 'obrigatoria',          'label' => 'Obrigatória', 'type' => 'select', 'options' => ['true', 'false']],
            ]],
            ['operation' => 'course.subject.delete', 'label' => 'Remover do currículo', 'confirm' => 'Remover esta disciplina do currículo?'],
        ],
    ],
    'course_subject_terms' => [
        'label' => 'Currículo — Períodos por disciplina', 'path' => '/api/escolar/course-subject-terms',
        'description' => 'Define em que períodos cada disciplina é leccionada e se tem exame. Uma linha por combinação disciplina × período.',
        'columns' => [
            ['subject_nome|course_subject_id', 'Disciplina'],
            ['term_nome|term_id', 'Período'],
            ['tem_exame', 'Tem exame'],
            ['peso_exame', 'Peso exame'],
        ],
        'create' => ['operation' => 'course.subject.term.create', 'label' => 'Definir disciplina em período', 'fields' => [
            ['name' => 'course_subject_id', 'label' => 'Disciplina no currículo (ID)', 'type' => 'number', 'required' => true],
            ['name' => 'term_id',           'label' => 'Período (ID)',                 'type' => 'number', 'required' => true],
            ['name' => 'tem_exame',         'label' => 'Tem exame neste período',      'type' => 'select', 'options' => ['false', 'true'], 'required' => true],
            ['name' => 'peso_exame',        'label' => 'Peso do exame (ex: 0.40)',     'type' => 'number'],
        ]],
        'actions' => [
            ['operation' => 'course.subject.term.update', 'label' => 'Editar', 'fields' => [
                ['name' => 'tem_exame',  'label' => 'Tem exame', 'type' => 'select', 'options' => ['false', 'true']],
                ['name' => 'peso_exame', 'label' => 'Peso do exame (ex: 0.40)', 'type' => 'number'],
            ]],
            ['operation' => 'course.subject.term.delete', 'label' => 'Remover período', 'confirm' => 'Remover a disciplina deste período?'],
        ],
    ],
    'teacher_assignments' => [
