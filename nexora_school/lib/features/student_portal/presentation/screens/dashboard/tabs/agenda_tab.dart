...
import 'package:nexora_school/features/agenda/domain/entities/aula_entity.dart';
...
import 'package:nexora_school/features/agenda/presentation/bloc/agenda_state.dart';
...
class _AgendaViewState extends State<_AgendaView>
  ...
  void _onTabChanged() {
    ...
    context.read<AgendaBloc>().add(
      AgendaViewModeChanged(_modes[_tabController.index]),
    );
  }
    ...
    return SizedBox(
      ...
      child: ListView.separated(
        ...
        itemBuilder: (context, i) {
          ...
          return InkWell(
            onTap: () =>
                context.read<AgendaBloc>().add(AgendaWeekdayChanged(i)),
        ...
        children: [
          ...
          if (aulas.isEmpty)
            ...
            ...aulas.asMap().entries.map(
              (e) =>
                  _SemanaRow(aula: e.value, isLast: e.key == aulas.length - 1),
            ),
        ],
      ),
    );
