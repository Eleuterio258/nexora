...
class _CreateAnnouncementScreenState extends State<CreateAnnouncementScreen> {
  ...
  static const _destinos = ['Todas as turmas', '10ª Classe A', '10ª Classe B', '11ª Classe A', '11ª Classe B'];
            ...
            children: [
              Row(
                children: [
                  ...
                  const Text('Novo Comunicado', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: _navy)),
                ],
              ),
              ...
              TextField(
                ...
                maxLines: 6,
                decoration: _inputDecoration('Escreva o conteúdo do comunicado...'),
              ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: const Text('Publicar Comunicado', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
                ),
              ),
            ],
          ),
