    ...
    <div class="portal-card">
        ...
        <div style="display:flex;flex-direction:column;gap:.65rem;font-size:.875rem">
            ...
            $campos = [
                ...
                'NÂº documento'  => $me['documento_numero'] ?? '',
                'NUIT'          => $me['nuit'] ?? '',
                'EndereÃ§o'      => $me['endereco'] ?? '',
            ];
...
async function alterarSenha() {
    ...
    if (novaSenha !== confirmarSenha) {
        msg.innerHTML = '<div style="background:#FEE2E2;color:#B91C1C;padding:.5rem .75rem;border-radius:6px;font-size:.82rem">As senhas nÃ£o coincidem.</div>';
        return;
    }
    ...
    const resp = await fetch('/portal/encarregado/api/alterar-senha', {
        method: 'POST',
