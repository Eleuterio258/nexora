...
/** @var \PHC\Application\DTO\DocumentDTO $doc */
/** @var InvoiceLayoutSettingsDTO|null $settings */

$settings ??= InvoiceLayoutSettingsDTO::fromEntity(\PHC\Domain\Entity\InvoiceLayoutSettings::defaults());
...
$template = in_array($settings->template, \PHC\Domain\Entity\InvoiceLayoutSettings::VALID_TEMPLATES, true)
    ? $settings->template
    : 'classic';
