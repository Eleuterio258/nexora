...
/**
 * Terminais POS — Portal Admin
 * Usa PosService para listar/criar terminais.
 */
...
$activePage = 'pos_admin_terminals';
$breadcrumb = [['Admin', '/nexora/'], ['POS', '/pos/gerente/dashboard'], ['Terminais', '']];
...
<div class="adm-card adm-mb-6">
    ...
    <div class="adm-table-wrap">
        <table class="adm-table">
            <thead>
                <tr><th>Código</th><th>Nome</th><th>Armazém</th><th>Estado</th></tr>
            </thead>
            <tbody>
            <?php foreach ($terminais as $t): ?>
            <tr>
                <td class="adm-fw-600"><?= htmlspecialchars($t['codigo']) ?></td>
                <td><?= htmlspecialchars($t['nome']) ?></td>
                <td><?= $t['warehouse_id'] ? htmlspecialchars($whMap[(int) $t['warehouse_id']] ?? ('#' . $t['warehouse_id'])) : '—' ?></td>
                <td><span class="adm-badge <?= $t['activo'] ? 'adm-badge--green' : 'adm-badge--gray' ?>"><?= $t['activo'] ? 'Activo' : 'Inactivo' ?></span></td>
            </tr>
            <?php endforeach; ?>
            </tbody>
        </table>
    ...
    <div class="adm-card-body">
        <div class="adm-form-row-3">
            ...
            <div class="adm-form-group">
                ...
                <select class="adm-select" id="t-armazem">
                    ...
                    <option value="<?= (int) $w['id'] ?>"><?= htmlspecialchars($w['codigo'] . ' - ' . $w['nome']) ?></option>
                    <?php endforeach; ?>
                </select>
        ...
        <div class="adm-form-row">
            <div class="adm-form-group">
                ...
                <p class="adm-help">É com ele que o terminal se autentica. Só é mostrado uma vez.</p>
            </div>
        </div>
